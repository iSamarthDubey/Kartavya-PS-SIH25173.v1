    ...
    <div className="h-full overflow-y-auto bg-synrgy-bg-900">
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        <div className="mb-8">
          ...
          <p className="text-synrgy-muted">Manage and track security incidents and investigations.</p>
        </div>
        ...
        <div className="bg-synrgy-surface border border-synrgy-primary/10 rounded-lg p-6">
          <div className="text-center py-12">
            ...
            <p className="text-synrgy-muted mb-6">Advanced investigation and forensics capabilities are being developed.</p>
